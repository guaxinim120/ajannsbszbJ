...
fun_botOnOff () {
      [[ $(ps x | grep "bot_plus"|grep -v grep | wc -l) = '0' ]] && {
          ...
          clear
          echo -e "\033[1;32mINICIANDO BOT MASTER DS MANAGER \033[0m\n"
          fun_bot1 () {
          ...
          fun_bar 'fun_bot1'
          [[ $(ps x | grep "bot_plus"|grep -v grep | wc -l) != '0' ]] && echo -e "\n\033[1;32m BOT MASTER DS MANAGER ATIVADO !\033[0m" || echo -e "\n\033[1;31m ERRO! REANALISE SUAS INFORMACOES\033[0m"
          sleep 3
          menu
      } || {
          clear
          echo -e "\033[1;32mPARANDO BOT MASTER DS MANAGER... \033[0m\n"
          fun_bot2 () {
...
fun_instbot () {
echo -e "\E[44;1;37m             INSTALADOR BOT MASTER DS MANAGER                \E[0m\n"
