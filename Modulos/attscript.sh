...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/Erikii/mashhhhshsh/master/versao
...
echo -e "                              \033[1;31mBy MASTER\033[1;36m"

echo -e "   MASTER DS MANAGER" | figlet
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37@masterdesignerp\n"
  ...
  echo -e "  \033[1;33mMAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@masterdesignerp\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/Erikii/mashhhhshsh/master/Plus > /dev/null 2>&1
